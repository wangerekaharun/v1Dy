...
public class AssignmentsAdapter extends RecyclerView.Adapter<AssignmentsAdapter.MyViewHolder> {
    ...
    public AssignmentsAdapter(Context context, ArrayList<Assignment_content_model> modelList) {
    ...
    @Override
    public void onBindViewHolder(AssignmentsAdapter.MyViewHolder holder, int position) {
        Assignment_content_model model = modelList.get(position);
        holder.textView_list_item_title.setText(model.getASSIGNMENT_NAME());
        holder.textView_list_item_name.setText(model.getASSIGNMENT_COURSE_NAME());
